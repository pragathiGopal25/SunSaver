...
class FrostDatasource @Inject constructor(private val client: HttpClient) {
    ...
    suspend fun fetchObservationDataFromFrost(
        ...
        sensorMap[elementName]?.forEach { value ->
        ...
        val getAvailableSensors =
            "https://frost.met.no/observations/availableTimeSeries/v0.jsonld?sources=$sensorUrl&referencetime=2022-12-31%2F2024-12-31&elements=${nameMap[elementName]}"
        ...
        var url =
            "https://frost.met.no/observations/v0.jsonld?sources=$sensorId&referencetime=$referenceTime&elements=${nameMap[elementName]}"
